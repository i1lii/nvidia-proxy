  ...
  try {
    ...
    if (!nimModel) {
      return res.status(400).json({
        error: {
          message: \`Model "\${model}" not found in mapping. Available: kimi, kimi-k3, moonshotai/kimi-k3, deepseek, gpt-4\`,
